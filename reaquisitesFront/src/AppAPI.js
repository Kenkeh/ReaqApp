...
export const userProjectList = (accountName) =>{
  return fetch(ServerRouteHTTPS+'user/'+accountName+'/projects', {
...
export const saveProject = (accountName, project) => {
  return fetch(ServerRouteHTTPS+'project/'+accountName+'/Update/'+project.projectId, {
    method: 'POST', // *GET, POST, PUT, DELETE, etc.
    mode: 'cors', // no-cors, *cors, same-origin
    cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
    credentials: 'same-origin', // include, *same-origin, omit
